...
def main():
    ...
    job_id = create_job("train", problem_id=prob_id); update_job_status(job_id, "running")
    ...
    pjob_id = create_job("predict", problem_id=prob_id, model_id=model_id); update_job_status(pjob_id, "running")
    ...
    print("dataset:", get_dataset(ds_id))
    print("model:", get_model(model_id))
    print("prediction:", get_prediction(pred_id))
    print("OK")
