...
Das Ziel hinter \code{PAaaS} ist die Schaffung eines Nutzerinterfaces sowie einer geeigneten RESTful API für verschiedene Methoden der prädiktiven Analyse. Dabei sollte das Tool leicht bedienbar, modular und skalierbar sein. Zudem soll das Ergebnis in bestehende Informationssysteme wie etwa ERP oder CRM integrierbar sein.
