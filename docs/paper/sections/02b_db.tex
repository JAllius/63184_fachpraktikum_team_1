...
ModellbeiBedarfarchiviert,das neue Modell als Production markiert und der Production-Pointer aktualisiert. Abbildung 3 zeigt die Schritte. Transaktionen und Isolation-Regeln liefern die nötige Konsistenz bei parallelen Requests \cite{1772InnoDBTransaction}.
